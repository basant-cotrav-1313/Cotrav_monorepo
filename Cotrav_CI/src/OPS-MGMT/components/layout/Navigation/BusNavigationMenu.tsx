...
export type BusNavigationGroup = {
  id: string;
  title: string;
  total: number;
  items: BusNavigationItem[];
};

type BusNavigationMenuProps = {
  groups: BusNavigationGroup[];
  collapsed: Record<string, boolean>;
  onToggleGroup: (groupId: string) => void;
  onNavigate: (path: string) => void;
};

const BusNavigationMenu: React.FC<BusNavigationMenuProps> = ({ groups, collapsed, onToggleGroup, onNavigate }) => {
  return (
...
export default BusNavigationMenu;
