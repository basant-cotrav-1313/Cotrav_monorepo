...
export type TrainNavigationGroup = {
  id: string;
  title: string;
  total: number;
  items: TrainNavigationItem[];
};

type TrainNavigationMenuProps = {
  groups: TrainNavigationGroup[];
  collapsed: Record<string, boolean>;
  onToggleGroup: (groupId: string) => void;
  onNavigate: (path: string) => void;
};

const TrainNavigationMenu: React.FC<TrainNavigationMenuProps> = ({ groups, collapsed, onToggleGroup, onNavigate }) => {
  return (
...
export default TrainNavigationMenu;
