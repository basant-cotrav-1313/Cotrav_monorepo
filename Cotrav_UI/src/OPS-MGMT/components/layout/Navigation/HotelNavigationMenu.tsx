...
export type HotelNavigationItem = {
  label: string;
  path: string;
  count: number;
...
export type HotelNavigationGroup = {
  id: string;
  title: string;
  total: number;
  items: HotelNavigationItem[];
};

type HotelNavigationMenuProps = {
  groups: HotelNavigationGroup[];
  collapsed: Record<string, boolean>;
  onToggleGroup: (groupId: string) => void;
  onNavigate: (path: string) => void;
};

const HotelNavigationMenu: React.FC<HotelNavigationMenuProps> = ({
  groups,
  collapsed,
  onToggleGroup,
  onNavigate
...
export default HotelNavigationMenu;
