...
import React from "react";
import OpsMainLayout from "@/OPS-MGMT/layouts/MainLayout";
import {SummaryTileGrid,EscalationPanel,QuickActionsPanel, QueueCardGrid } from '@/OPS-MGMT/modules/finance/vouchers/vouchers-dashboard'

const VoucherDashboardPage: React.FC = () => (
  <OpsMainLayout
    pageTitle="Voucher Dashboard"
    pageSubtitle="Finance - Voucher workflow and payment tracking"
  >
    <div className="w-full bg-slate-50 p-4 text-slate-800">
      <div className="mx-auto max-w-[1300px]">
        ...
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Finance - Voucher workflow, payment tracking and escalation control
          </p>
        </div>
