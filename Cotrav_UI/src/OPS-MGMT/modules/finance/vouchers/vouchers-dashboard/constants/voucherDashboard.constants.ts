import type { SummaryTile, EscalationTile, QuickAction, QueueCard } from "../types/voucherDashboard.types";
...
export const ESCALATION_TILES: EscalationTile[] = [
  {
...
export const QUEUE_CARDS: QueueCard[] = [
  {
    title:        "Raised",
